...
/*	
	...
	/*	function onFade(){
		if (i < dots){		
			...
			$(".main_imgs li").stop().eq(i).fadeOut(900);
	        $(".main_imgs li").stop().eq(i).next("li").fadeIn(900);
			i++;				
		}else if (i == dots){
			$(".main_imgs > li").stop().eq(i).fadeOut(900);
	        $(".main_imgs > li").stop().eq(0).fadeIn(900);
			i = 0;
		  	$(".dots li").removeClass("dot_on");
	     	$(".dots li").eq(0)	.addClass("dot_on");			
			};			
	...
	$(".theLeft").click(function (){
		if (i > 0){		
			...
			$(".main_imgs li").eq(i).fadeOut(900);
	        $(".main_imgs li").eq(i).prev("li").fadeIn(900);
			i-=1;				
		}else if (i == 0){
			$(".main_imgs > li").eq(i).fadeOut(900);
	        $(".main_imgs > li").eq(2).fadeIn(900);
			i = 2;
		  	$(".dots li").removeClass("dot_on");
	     	$(".dots li").eq(2)	.addClass("dot_on");			
			};			
	...
	$(".dots li").click(function (){
		...
		$(".main_imgs > li").fadeOut(500);
	    $(".main_imgs > li").eq(click_dots).fadeIn(500);
